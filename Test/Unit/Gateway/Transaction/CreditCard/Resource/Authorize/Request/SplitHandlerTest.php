...
use Webjump\BraspagPagador\Gateway\Transaction\CreditCard\Resource\Authorize\Request\SplitHandler;
...
class SplitHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->paymentSplitRequestMock = $this->createMock(\Webjump\BraspagPagador\Gateway\Transaction\CreditCard\Resource\PaymentSplit\Request::class);
