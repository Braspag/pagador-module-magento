...
class ValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $configInterface = $this->createMock('Braspag\BraspagPagador\Gateway\Transaction\CreditCard\Config\ConfigInterface');
        $this->responseMock = $this->createMock('Braspag\Braspag\Pagador\Transaction\Api\CreditCard\Send\ResponseInterface');
