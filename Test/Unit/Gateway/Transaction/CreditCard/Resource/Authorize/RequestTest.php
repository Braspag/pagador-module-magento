...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetData()
    {
        ...
        $infoMock = $this->getMockBuilder('Magento\Payment\Model\Info')
            ...
            ->setMethods(['getCcType', 'getAdditionalInformation', 'getCcNumber', 'getCcOwner', 'getCcExpMonth', 'getCcExpYear', 'getCcCid'])
            ->getMock();
        ...
        static::assertFalse($this->request->getPaymentCreditCardSaveCard());
