...
use Braspag\BraspagPagador\Gateway\Transaction\CreditCard\Resource\Capture\Response\Validator;
...
class ValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->responseMock = $this->createMock('Braspag\Braspag\Pagador\Transaction\Api\Actions\Capture\ResponseInterface');
