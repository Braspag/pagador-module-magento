...
namespace Braspag\BraspagPagador\Test\Unit\Gateway\Transaction\DebitCard\Resource\Order\Request;

use Magento\Quote\Model\Quote;
use Braspag\BraspagPagador\Gateway\Transaction\DebitCard\Resource\Order\Request\SplitHandler;
...
class SplitHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->paymentSplitRequestMock = $this->createMock(\Braspag\BraspagPagador\Gateway\Transaction\DebitCard\Resource\PaymentSplit\Request::class);
