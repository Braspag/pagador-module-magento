...
use Braspag\BraspagPagador\Gateway\Transaction\DebitCard\Resource\Order\Response\Validator;
...
class ValidatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $configInterface = $this->createMock('Braspag\BraspagPagador\Gateway\Transaction\DebitCard\Config\ConfigInterface');
        $this->responseMock = $this->createMock('Braspag\Braspag\Pagador\Transaction\Api\DebitCard\Send\ResponseInterface');
