...
namespace Webjump\BraspagPagador\Test\Unit\Gateway\Transaction\Boleto\Resource\PaymentSplit;

use Magento\Quote\Model\Quote;
use Webjump\BraspagPagador\Api\SplitDataProviderInterface;
use Webjump\BraspagPagador\Gateway\Transaction\Boleto\Resource\PaymentSplit\Request;
use PHPUnit\Framework\TestCase;
use Webjump\BraspagPagador\Gateway\Transaction\Boleto\Config\Config as PaymentSplitConfig;
...
class RequestTest extends TestCase
{
    ...
    public function testGetAccessToken()
    {
        ...
        $this->assertEquals($result, '1234567891');
    }
