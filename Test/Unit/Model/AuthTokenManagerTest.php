...
class AuthTokenManagerTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->requestMock = $this->createMock(\Webjump\BraspagPagador\Gateway\Transaction\Auth\Resource\Token\RequestInterface::class);
        $this->tokenCommandMock = $this->createMock(\Webjump\BraspagPagador\Gateway\Transaction\Auth\Command\TokenCommand::class);
        ...
        $this->builderMock = $this->createMock(\Webjump\BraspagPagador\Gateway\Transaction\Auth\Resource\Token\BuilderInterface::class);
    ...
    public function getTokenSuccessTest()
    {
        ...
        $this->cookieManagerMock
            ->expects($this->once())
            ->method('getCookie')
            ->with(\Webjump\BraspagPagador\Gateway\Transaction\Auth\Resource\Token\RequestInterface::BPMPI_ACCESS_TOKEN_COOKIE_NAME, false)
